...
export default function HoldingsChart({
  ...
  const {
    ...
    const latestPrice = chartData.length
            ...
            {indicatorSettings.map((ind) => (
              ...
              >
                <input
                  ...
                  className="form-checkbox h-4 w-4 text-cyan-500 bg-gray-700 rounded focus:ring-0"
                />
                <label
                  htmlFor={ind.id}
                ...
                {activeSettings === ind.id && (
                  <motion.div
                    ...
                    className="absolute top-full left-0 mt-2 w-44 z-30 bg-gray-900 border border-gray-700 rounded-xl p-3 shadow-xl"
                  >
                    ...
                    <input
                      ...
                      className="w-full bg-gray-800 border border-gray-700 text-white text-sm rounded-md px-2 py-1 outline-none focus:ring-1 focus:ring-cyan-500"
                    />
                  </motion.div>
                )}
              </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
            <div className="text-center p-2 rounded-lg bg-gray-800/50">
              ...
              <div className="text-white font-semibold">
                ₹{Math.max(...priceHistory.map((p) => p.close))}
              </div>
            </div>
            <div className="text-center p-2 rounded-lg bg-gray-800/50">
              <div className="text-gray-400 text-xs uppercase tracking-wide mb-1">
              ...
              <div className="text-white font-semibold">
                ₹{Math.min(...priceHistory.map((p) => p.close))}
              </div>
            </div>
            <div className="text-center p-2 rounded-lg bg-gray-800/50">
              <div className="text-gray-400 text-xs uppercase tracking-wide mb-1">
