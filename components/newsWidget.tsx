...
export function NewsWidget() {
  ...
  return (
    ...
    >
      <Card className="bg-zinc-900/80 backdrop-blur-md border border-zinc-700 rounded-2xl shadow-2xl text-white">
              ...
              <div className="space-y-4 max-h-[400px] overflow-y-auto pr-1 custom-scrollbar">
                {isLoading ? (
                  ...
                  news.map((item) => (
                    <motion.div
                      key={item.id}
                      className="p-4 bg-zinc-800 rounded-xl hover:bg-zinc-700 transition cursor-pointer"
